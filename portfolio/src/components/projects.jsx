...
function projects(props) {
  return (
    <div id="project-conatiner">
            <div className="grid gap-2">
                <span className="flex justify-between">
                    <h1 className="font-Utara font-medium capitalize ">{props.brand}</h1>
                    <a href="">
            ...
            <div className="text-stone-950 text-[15px] font-normal font-Utara capitalize">
                ...
                <div className="w-full grid gap-3">
                    <div className="grid grid-flow-col scroll-smooth gap-2 overflow-x-auto  w-full">
                        <div className="w-72  h-60  bg-black"  style={{
                                backgroundImage: `url(${props.poster1})`,
                                backgroundSize: 'cover',
                                backgroundPosition: 'center',
                            }}>
                        </div>
                        <div className="w-72  h-60  bg-black" style={{
                                backgroundImage: `url(${props.poster2})`,
                                backgroundSize: 'cover',
                                backgroundPosition: 'center',
                            }} > </div>
                        <div className="w-72  h-60  bg-black" style={{
                                backgroundImage: `url(${props.poster3})`,
                                backgroundSize: 'cover',
                                backgroundPosition: 'center',
                            }}> </div>
                        <div className="w-72  h-60  bg-black" style={{
                                backgroundImage: `url(${props.poster4})`,
                                backgroundSize: 'cover',
                                backgroundPosition: 'center',
                            }} > </div>
                        <div className="w-72  h-60  bg-black" style={{
                                backgroundImage: `url(${props.poster5})`,
                                backgroundSize: 'cover',
                                backgroundPosition: 'center',
                            }} ></div>
                    </div>
                    ...
                    {/* <li className={` bg-gray-950   text-white px-3 py-2 w-fit rounded-2xl ${props.tools[0] =="" && ("hidden")}`}>
                        {props.tools[0]}
                    </li>
                    <li className={` bg-gray-950   text-white px-3 py-2 w-fit rounded-2xl ${props.tools[0] =="" && ("hidden")}`}>
                        {props.tools[0]}
                    ...
                    <li className={` bg-gray-950   text-white px-3 py-2 w-fit rounded-2xl ${props.tools[0] =="" && ("hidden")}`}>
                     ...
                     <li className=" bg-gray-950   text-white px-3 py-2 w-fit rounded-2xl">{props.tools[0]}</li>
                     <li className=" bg-gray-950   text-white px-3 py-2 w-fit rounded-2xl">{props.tools[1]}</li>
                     <li className=" bg-gray-950   text-white px-3 py-2 w-fit rounded-2xl">{props.tools[2]}</li>
                    </ul>
                </div>
            </div>
        </div>
...
projects.propTypes = {
    ...
    poster1: PropTypes.string,
    poster2: PropTypes.string,
    poster3: PropTypes.string,
    poster4: PropTypes.string,
    poster5: PropTypes.string,
};
